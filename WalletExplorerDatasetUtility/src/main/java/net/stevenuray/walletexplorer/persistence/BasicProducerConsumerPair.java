 ...
 */
public class BasicProducerConsumerPair<T,U> implements DataPipeline<T, U> {
	private final DataConsumer<U> consumer;
	private final DataProducer<T> producer;
	
	public BasicProducerConsumerPair(DataProducer<T> producer,DataConsumer<U> consumer){
